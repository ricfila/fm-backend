__all__ = (
    ...
    "get_menus_router",
    "update_menu_daily_max_sales_router",
...
from .update_menu_daily_max_sales import update_menu_daily_max_sales_router
...
menus.include_router(update_menu_daily_max_sales_router)
