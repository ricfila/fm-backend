...
menu.include_router(update_menu_field_is_optional_router)
menu.include_router(update_menu_field_max_sortable_elements_router)
menu.include_router(update_menu_field_name_router)
